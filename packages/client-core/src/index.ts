...
export { poll, revalidateOnFocus, revalidateOnReconnect } from './freshness.js';
export type { FocusOptions, PollOptions, ReconnectOptions, VisibilityLike } from './freshness.js';
