...
type PluginSource = common2.PluginSource

// PluginSourceType defines the type of plugin source
type PluginSourceType = common2.PluginSourceType

const (
	PluginSourceTypeFile        = common2.PluginSourceTypeFile
	PluginSourceTypeURL         = common2.PluginSourceTypeURL
	PluginSourceTypeMarketplace = common2.PluginSourceTypeMarketplace
	PluginSourceTypeGit         = common2.PluginSourceTypeGit
	PluginSourceTypeRegistry    = common2.PluginSourceTypeRegistry
)
...
func (pm *PluginManagerImpl) OnStop(ctx context.Context) error {
	...
	// OnStop all plugins in reverse dependency order
...
func (pm *PluginManagerImpl) LoadPlugin(ctx context.Context, source PluginSource) (Plugin, error) {
	...
	// OnStart monitoring plugin security
...
func (pm *PluginManagerImpl) getDefaultRoleForPlugin(plugin Plugin) string {
	switch plugin.Type() {
	case common2.PluginTypeService, common2.PluginTypeMiddleware:
