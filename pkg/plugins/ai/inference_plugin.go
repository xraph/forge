...
func (p *BaseInferencePlugin) Type() plugins.PluginType {
...
func (p *BaseInferencePlugin) Capabilities() []plugins.PluginCapability {
	return []plugins.PluginCapability{}
}
func (p *BaseInferencePlugin) Dependencies() []plugins.PluginDependency {
...
func (p *BaseInferencePlugin) GetMetrics() plugins.PluginMetrics     { return plugins.PluginMetrics{} }
