...
func (p *BaseTrainingPlugin) Type() plugins.PluginType {
...
// Placeholder implementations for common.Plugin interface
func (p *BaseTrainingPlugin) Capabilities() []plugins.PluginCapability {
	return []plugins.PluginCapability{}
}
func (p *BaseTrainingPlugin) Dependencies() []plugins.PluginDependency {
...
func (p *BaseTrainingPlugin) GetMetrics() plugins.PluginMetrics     { return plugins.PluginMetrics{} }
