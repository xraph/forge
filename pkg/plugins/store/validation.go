...
type ValidationRule interface {
	Name() string
	Description() string
	Validate(ctx context.Context, pkg plugins.PluginPackage) ValidationResult
...
func (pv *PluginValidator) ValidatePackage(ctx context.Context, pkg plugins.PluginPackage) error {
...
func (pv *PluginValidator) ValidatePackageDetailed(ctx context.Context, pkg plugins.PluginPackage) ValidationReport {
	startTime := time.Now()
...
func (r *ChecksumValidationRule) Validate(ctx context.Context, pkg plugins.PluginPackage) ValidationResult {
	if pkg.Checksum == "" {
...
func (r *FileSizeValidationRule) Validate(ctx context.Context, pkg plugins.PluginPackage) ValidationResult {
...
func (r *MalwareDetectionRule) Validate(ctx context.Context, pkg plugins.PluginPackage) ValidationResult {
...
func (r *PluginInfoValidationRule) Validate(ctx context.Context, pkg plugins.PluginPackage) ValidationResult {
	info := pkg.Info
...
func (r *BinaryFormatValidationRule) Validate(ctx context.Context, pkg plugins.PluginPackage) ValidationResult {
	if len(pkg.Binary) == 0 {
		return ValidationResult{
			Rule:     r.Name(),
			Category: r.Category(),
...
func (r *ConfigSchemaValidationRule) Validate(ctx context.Context, pkg plugins.PluginPackage) ValidationResult {
...
func (r *VersionValidationRule) Validate(ctx context.Context, pkg plugins.PluginPackage) ValidationResult {
	version := pkg.Info.Version
...
func (r *LicenseValidationRule) Validate(ctx context.Context, pkg plugins.PluginPackage) ValidationResult {
...
func (r *AuthorValidationRule) Validate(ctx context.Context, pkg plugins.PluginPackage) ValidationResult {
...
func (r *DependencyValidationRule) Validate(ctx context.Context, pkg plugins.PluginPackage) ValidationResult {
...
func (r *CircularDependencyRule) Validate(ctx context.Context, pkg plugins.PluginPackage) ValidationResult {
...
func (r *APICompatibilityRule) Validate(ctx context.Context, pkg plugins.PluginPackage) ValidationResult {
...
func (r *InterfaceValidationRule) Validate(ctx context.Context, pkg plugins.PluginPackage) ValidationResult {
...
func (r *PerformanceAnalysisRule) Validate(ctx context.Context, pkg plugins.PluginPackage) ValidationResult {
