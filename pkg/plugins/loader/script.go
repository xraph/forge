...
func (sl *ScriptLoader) LoadPlugin(ctx context.Context, source plugins.PluginSource) (plugins.Plugin, error) {
	startTime := time.Now()
...
func (sl *ScriptLoader) ValidateSource(source plugins.PluginSource) error {
	if source.Location == "" {
...
func (sl *ScriptLoader) GetMetadata(source plugins.PluginSource) (*plugins.PluginInfo, error) {
	scriptPath, err := sl.resolveScriptPath(source)
	if err != nil {
		return nil, fmt.Errorf("failed to resolve script path: %w", err)
	}
...
func (sl *ScriptLoader) resolveScriptPath(source plugins.PluginSource) (string, error) {
	switch source.Type {
...
func (sl *ScriptLoader) loadScriptMetadata(scriptPath string) (*plugins.PluginInfo, error) {
...
func (sl *ScriptLoader) loadMetadataFromJSON(path string) (*plugins.PluginInfo, error) {
...
func (sl *ScriptLoader) extractMetadataFromScript(scriptPath string) (*plugins.PluginInfo, error) {
...
func (spw *ScriptPluginWrapper) Type() plugins.PluginType                 { return spw.pluginType }
func (spw *ScriptPluginWrapper) Capabilities() []plugins.PluginCapability { return spw.capabilities }
func (spw *ScriptPluginWrapper) Dependencies() []plugins.PluginDependency { return spw.dependencies }
...
func (spw *ScriptPluginWrapper) GetMetrics() plugins.PluginMetrics {
