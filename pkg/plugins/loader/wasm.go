...
func (wl *WASMLoader) LoadPlugin(ctx context.Context, source plugins.PluginSource) (plugins.Plugin, error) {
	startTime := time.Now()
...
func (wl *WASMLoader) ValidateSource(source plugins.PluginSource) error {
	if source.Location == "" {
...
func (wl *WASMLoader) GetMetadata(source plugins.PluginSource) (*plugins.PluginInfo, error) {
	wasmPath, err := wl.resolveWASMPath(source)
	if err != nil {
		return nil, fmt.Errorf("failed to resolve WASM path: %w", err)
	}
...
func (wl *WASMLoader) resolveWASMPath(source plugins.PluginSource) (string, error) {
	switch source.Type {
...
func (wl *WASMLoader) loadWASMMetadata(wasmPath string) (*plugins.PluginInfo, error) {
...
func (wl *WASMLoader) loadMetadataFromJSON(path string) (*plugins.PluginInfo, error) {
...
func (wl *WASMLoader) extractMetadataFromWASM(wasmPath string) (*plugins.PluginInfo, error) {
...
func (wpw *WASMPluginWrapper) Type() plugins.PluginType                 { return wpw.pluginType }
func (wpw *WASMPluginWrapper) Capabilities() []plugins.PluginCapability { return wpw.capabilities }
func (wpw *WASMPluginWrapper) Dependencies() []plugins.PluginDependency { return wpw.dependencies }
...
func (wpw *WASMPluginWrapper) GetMetrics() plugins.PluginMetrics {
