...
type PluginLoader interface {
	LoadPlugin(ctx context.Context, source plugins.PluginSource) (plugins.Plugin, error)
	...
	ValidateSource(source plugins.PluginSource) error
}
...
type Loader interface {
	...
	LoadPlugin(ctx context.Context, source plugins.PluginSource) (plugins.Plugin, error)
	ValidateSource(source plugins.PluginSource) error
	GetMetadata(source plugins.PluginSource) (*plugins.PluginInfo, error)
}
...
func (pl *PluginLoaderImpl) LoadPlugin(ctx context.Context, source plugins.PluginSource) (plugins.Plugin, error) {
	pl.mu.RLock()
	defer pl.mu.RUnlock()
...
func (pl *PluginLoaderImpl) ValidateSource(source plugins.PluginSource) error {
	if source.Location == "" {
...
func (pl *PluginLoaderImpl) determineLoaderType(source plugins.PluginSource) (LoaderType, error) {
