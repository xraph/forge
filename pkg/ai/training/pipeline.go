...
func NewTrainingPipeline(config PipelineConfig, logger common.Logger) TrainingPipeline {
...
func (p *TrainingPipelineImpl) GetStage(stageID string) (PipelineStage, error) {
	...
	if !exists {
		return nil, common.ErrServiceNotFound(stageID)
	}
...
func NewPipelineExecution(pipelineID string, input PipelineInput, logger common.Logger) PipelineExecution {
