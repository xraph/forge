...
func (wpw *WASMPluginWrapper) Capabilities() []plugins.PluginEngineCapability { return wpw.capabilities }
func (wpw *WASMPluginWrapper) Dependencies() []plugins.PluginEngineDependency { return wpw.dependencies }
