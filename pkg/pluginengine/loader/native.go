...
func (npw *NativePluginWrapper) Capabilities() []plugins.PluginEngineCapability { return npw.capabilities }
func (npw *NativePluginWrapper) Dependencies() []plugins.PluginEngineDependency { return npw.dependencies }
