...
func RegisterMemoryHealthChecks(healthService health.HealthService) error {
	...
	if err := healthService.RegisterCheck("memory", memoryCheck); err != nil {
	...
	if err := healthService.RegisterCheck("goroutines", goroutineCheck); err != nil {
	...
	if err := healthService.RegisterCheck("heap", heapCheck); err != nil {
	...
	if err := healthService.RegisterCheck("gc", gcCheck); err != nil {
