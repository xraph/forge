...
func main() {
    ...
    // Object storage is required for segment storage
    app.RegisterExtension(troveext.New(
        troveext.WithFileStoreDSN("media", "file:///var/data/media"),
        troveext.WithDefaultFileStore("media"),
    ))
