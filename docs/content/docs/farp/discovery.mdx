...
A gateway can use FARP to auto-configure its routes. The Forge gateway
extension that did this has been removed; use
[Bastion](https://github.com/xraph/bastion), which ships its own Forge
extension and reads the same FARP manifests.
