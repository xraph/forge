...
Build one in your server component, as above, and pass it to `ClientProvider` if anything on the server needs to read from it. See [Framework adapters](/docs/web-client/adapters) for how the provider resolves.
