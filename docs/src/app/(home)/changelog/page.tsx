...
const changes = [
  {
    ...
    description:
      "Addressed issues with dependency injection in nested scopes and improved HTTP router performance.",
    type: "patch",
  },
  {
    version: "v1.0.0",
    ...
    description:
      "Welcome to Forge! The first production-ready release including all core modules.",
    type: "major",
  },
];
        ...
        {changes.map((change, i) => (
          <div key={i} className="relative pl-8 border-l border-fd-border">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mb-2">
              ...
              <span
                className={`text-xs px-2 py-0.5 rounded-full border w-fit ${change.type === "major" ? "border-red-500 text-red-600 bg-red-500/10" : "border-blue-500 text-blue-600 bg-blue-500/10"}`}
              >
                {change.type}
              </span>
            </div>
