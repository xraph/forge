...
const posts = [
    {
        ...
        excerpt: 'Today we are announcing Forge, a new framework designed to help you build scalable backend services in Go with ease.',
        date: '2025-01-01',
        author: 'Rex Raphael',
        readTime: '5 min read',
    },
    {
        ...
        excerpt: 'Learn how to leverage Forge\'s type-safe dependency injection container to write clean, testable code.',
        date: '2025-01-10',
        author: 'Forge Team',
        readTime: '8 min read',
    },
    {
        ...
        excerpt: 'A comprehensive guide to extending Forge\'s capabilities with your own custom modules.',
        date: '2025-01-20',
        author: 'Rex Raphael',
        readTime: '6 min read',
    },
                ...
                {posts.map((post) => (
                    ...
                    >
                        <article className="h-full flex flex-col rounded-2xl border border-fd-border bg-fd-card overflow-hidden transition-all hover:border-fd-border/80 hover:shadow-lg">
                            <div className="h-48 bg-fd-accent/50 group-hover:bg-fd-accent transition-colors" /> {/* Placeholder image */}
