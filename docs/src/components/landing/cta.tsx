...
export function CTA() {
  ...
  return (
    <section className="container max-w-(--fd-layout-width) mx-auto px-6 py-16 md:py-24 border-t border-fd-border">
      <motion.div
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center text-center py-16 md:py-20 px-6">
          ...
          <div className="inline-flex items-center gap-3 border border-fd-border bg-fd-background px-5 py-3 font-mono text-sm mb-8">
