...
const features = [
  {
    ...
    desc: "Services auto-register via mDNS/Bonjour. No manual catalogs needed.",
  },
  {
    icon: RefreshCw,
    title: "FARP Protocol",
  ...
  return (
    <div className="relative w-full h-[300px] bg-zinc-950/50 rounded-none border border-fd-border overflow-hidden p-8 flex items-center justify-center">
      ...
      <div className="relative z-10 flex items-center gap-8 md:gap-16 w-full max-w-2xl justify-center">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            ...
            <div className="text-xs text-fd-muted-foreground mt-1 bg-fd-accent px-2 py-0.5 rounded-full">
              FARP Enabled
            </div>
          </div>
        </div>
      ...
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-4">
        <span className="text-[10px] uppercase tracking-wider text-fd-muted-foreground border border-fd-border px-2 py-1 rounded bg-fd-background/50 backdrop-blur">
          mDNS Discovery
        </span>
        <span className="text-[10px] uppercase tracking-wider text-fd-muted-foreground border border-fd-border px-2 py-1 rounded bg-fd-background/50 backdrop-blur">
          Reverse Proxy
