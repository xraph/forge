          ...
          <div className="p-5 sm:p-8 lg:p-12 flex flex-col justify-center order-2 lg:order-1">
            ...
            <div className="space-y-4">
              {[
                {
                  icon: Container,
                  label: "Automatic Containerization",
                  desc: "No Dockerfile required. We generate one optimized for dev.",
                },
                {
                  icon: Layers,
                  label: "Live Reloading",
                  desc: "Changes sync instantly to the running container.",
                },
                {
                  icon: Box,
                  label: "Production Parity",
                  desc: "Develop in the same environment you deploy to.",
                },
              ].map((item, i) => (
