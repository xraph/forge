...
type CustomHealthCheckBuilder struct {
	name         string
	checkFunc    shared.HealthCheckFn
...
func (b *CustomHealthCheckBuilder) WithMetadata(metadata map[string]any) *CustomHealthCheckBuilder {
...
func (b *ServiceHealthCheckBuilder) BuildForService(serviceName string) health.HealthCheck {
	return NewCustomHealthCheckBuilder("service-"+serviceName, func(ctx context.Context) *health.HealthResult {
...
func (b *ServiceHealthCheckBuilder) checkService(ctx context.Context, serviceName string) *health.HealthResult {
	...
	service, err := b.container.Resolve(serviceName)
	if err != nil {
		return result.
...
func (b *ResourceHealthCheckBuilder) BuildFileSystemCheck(name, path string, minFreeSpace int64) health.HealthCheck {
	return NewCustomHealthCheckBuilder("filesystem-"+name, func(ctx context.Context) *health.HealthResult {
...
func (b *ResourceHealthCheckBuilder) BuildPortCheck(name, host string, port int) health.HealthCheck {
	return NewCustomHealthCheckBuilder("port-"+name, func(ctx context.Context) *health.HealthResult {
...
func checkFileSystem(path string, minFreeSpace int64) *health.HealthResult {
	result := health.NewHealthResult("filesystem-"+path, health.HealthStatusHealthy, "filesystem is healthy")
...
func CreateCustomHealthCheckFromMethod(name string, obj any, methodName string) (health.HealthCheck, error) {
