module github.com/xraph/forge/examples/orpc_example

go 1.25.3

replace github.com/xraph/forge => ../..

replace github.com/xraph/forge/extensions/orpc => ../../extensions/orpc

require (
	github.com/xraph/forge v0.0.6
	github.com/xraph/forge/extensions/orpc v0.0.0-00010101000000-000000000000
)
