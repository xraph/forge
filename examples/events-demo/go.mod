module github.com/xraph/forge/examples/events-demo

go 1.25.3

replace github.com/xraph/forge => ../..

replace github.com/xraph/forge/extensions/events => ../../extensions/events

require (
	github.com/xraph/forge v0.8.6
	github.com/xraph/forge/extensions/events v0.0.0-00010101000000-000000000000
)
