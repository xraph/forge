...
func NewContentPersonalization(config PersonalizationConfig, logger common.Logger, metrics common.Metrics) (*ContentPersonalization, error) {
...
func (cp *ContentPersonalization) Type() ai.AIMiddlewareType {
	return ai.AIMiddlewareTypePersonalization
}
