...
func NewAIDashboard(aiManager ai.AIManager, healthMonitor *AIHealthMonitor, metricsCollector *AIMetricsCollector, alertManager *AIAlertManager, logger common.Logger, metrics common.Metrics, config DashboardConfig) *AIDashboard {
...
func (d *AIDashboard) collectAgentMetricsData(ctx context.Context) (*AgentMetricsData, error) {
	...
	for _, agent := range agents {
		...
		// Check for issues
		if health.Status != aicore.AgentHealthStatusHealthy {
