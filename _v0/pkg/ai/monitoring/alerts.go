...
func NewAIAlertManager(aiManager ai.AIManager, healthMonitor *AIHealthMonitor, metricsCollector *AIMetricsCollector, logger common.Logger, metrics common.Metrics, config AIAlertConfig) *AIAlertManager {
