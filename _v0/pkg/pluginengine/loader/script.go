...
func (spw *ScriptPluginWrapper) Capabilities() []plugins.PluginEngineCapability {
	return spw.capabilities
}
func (spw *ScriptPluginWrapper) Dependencies() []plugins.PluginEngineDependency {
	return spw.dependencies
}
