...
type PluginSandbox interface {
	...
	Execute(ctx context.Context, plugin plugins.PluginEngine, operation plugins.PluginEngineOperation) (interface{}, error)
	Monitor(ctx context.Context, plugin plugins.PluginEngine) (SandboxMetrics, error)
...
func (s *SandboxImpl) Execute(ctx context.Context, plugin plugins.PluginEngine, operation plugins.PluginEngineOperation) (interface{}, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *SandboxImpl) Monitor(ctx context.Context, plugin plugins.PluginEngine) (SandboxMetrics, error) {
	s.mu.RLock()
	defer s.mu.RUnlock()
...
func (s *SandboxImpl) executeOperation(ctx context.Context, plugin plugins.PluginEngine, operation plugins.PluginEngineOperation) (interface{}, error) {
...
func (s *SandboxImpl) executeLoad(ctx context.Context, plugin plugins.PluginEngine, operation plugins.PluginEngineOperation) (interface{}, error) {
...
func (s *SandboxImpl) executeStart(ctx context.Context, plugin plugins.PluginEngine, operation plugins.PluginEngineOperation) (interface{}, error) {
	// Execute plugin start
	return nil, plugin.OnStart(ctx)
}

func (s *SandboxImpl) executeStop(ctx context.Context, plugin plugins.PluginEngine, operation plugins.PluginEngineOperation) (interface{}, error) {
	// Execute plugin stop
	return nil, plugin.OnStop(ctx)
}

func (s *SandboxImpl) executeCustom(ctx context.Context, plugin plugins.PluginEngine, operation plugins.PluginEngineOperation) (interface{}, error) {
...
func (s *SandboxImpl) monitorExecution(ctx context.Context, operation plugins.PluginEngineOperation) {
