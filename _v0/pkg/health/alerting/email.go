...
func NewEmailNotifier(name string, config *EmailConfig, logger common.Logger, metrics common.Metrics) (*EmailNotifier, error) {
	if config == nil {
...
func (enb *EmailNotifierBuilder) WithLogger(logger common.Logger) *EmailNotifierBuilder {
	enb.logger = logger
	return enb
}

// WithMetrics sets the metrics collector
func (enb *EmailNotifierBuilder) WithMetrics(metrics common.Metrics) *EmailNotifierBuilder {
	enb.metrics = metrics
	return enb
}
...
func NewGmailNotifier(name, username, password, from string, to []string, logger common.Logger, metrics common.Metrics) (*EmailNotifier, error) {
...
func NewOutlookNotifier(name, username, password, from string, to []string, logger common.Logger, metrics common.Metrics) (*EmailNotifier, error) {
	return NewEmailNotifierBuilder(name).
...
func NewSMTPNotifier(name, host string, port int, username, password, from string, to []string, logger common.Logger, metrics common.Metrics) (*EmailNotifier, error) {
	return NewEmailNotifierBuilder(name).
		WithSMTP(host, port).
		WithAuth(username, password).
		WithFrom(from).
