...
func NewExternalAPIHealthCheckFactory(container common.Container) *ExternalAPIHealthCheckFactory {
...
func RegisterExternalAPIHealthChecks(healthService health.HealthService, container common.Container) error {
	...
	for _, api := range externalAPIs {
		...
		if err := healthService.RegisterCheck(api.name, check); err != nil {
