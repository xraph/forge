...
func RegisterDiskHealthChecks(healthService health.HealthService) error {
	...
	if err := healthService.RegisterCheck("disk", diskCheck); err != nil {
	...
	if err := healthService.RegisterCheck("disk-io", ioCheck); err != nil {
	...
	if err := healthService.RegisterCheck("temp-dir", tempCheck); err != nil {
	...
	if err := healthService.RegisterCheck("log-dir", logCheck); err != nil {
