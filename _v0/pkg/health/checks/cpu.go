...
func RegisterCPUHealthChecks(healthService *health.HealthService) error {
	...
	if err := healthService.RegisterCheck("cpu", cpuCheck); err != nil {
	...
	if err := healthService.RegisterCheck("cpu-load", loadCheck); err != nil {
	...
	if err := healthService.RegisterCheck("cpu-context-switch", contextSwitchCheck); err != nil {
	...
	if err := healthService.RegisterCheck("cpu-throttling", throttlingCheck); err != nil {
