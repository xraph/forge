...
func convertHandler(handler any, container Container, errorHandler ErrorHandler) (http.Handler, error) {
...
func convertContextHandler(info *handlerInfo, container Container, errorHandler ErrorHandler) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := newContext(w, r, container)
		defer ctx.cleanup()
...
func convertOpinionatedHandler(info *handlerInfo, container Container, errorHandler ErrorHandler) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := newContext(w, r, container)
		defer ctx.cleanup()
...
func convertServiceHandler(info *handlerInfo, container Container, errorHandler ErrorHandler) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := newContext(w, r, container)
		defer ctx.cleanup()
...
func convertCombinedHandler(info *handlerInfo, container Container, errorHandler ErrorHandler) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := newContext(w, r, container)
		defer ctx.cleanup()
