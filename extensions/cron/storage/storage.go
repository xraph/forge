...
func ToJobUpdate(v any) *cron.JobUpdate {
	if v == nil {
		return nil
	}
...
func ToJobExecution(v any) *cron.JobExecution {
	if v == nil {
		return nil
	}
...
func ToExecutionFilter(v any) *cron.ExecutionFilter {
	if v == nil {
		return nil
	}
...
func ToJobStats(v any) *cron.JobStats {
	if v == nil {
		return nil
	}
...
func ToJobExecutions(v []any) []*cron.JobExecution {
	if v == nil {
		return nil
	}
