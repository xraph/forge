...
func (s *MockSugarLogger) Debugw(msg string, keysAndValues ...interface{}) {}
func (s *MockSugarLogger) Infow(msg string, keysAndValues ...interface{})  {}
func (s *MockSugarLogger) Warnw(msg string, keysAndValues ...interface{})  {}
func (s *MockSugarLogger) Errorw(msg string, keysAndValues ...interface{}) {}
func (s *MockSugarLogger) Fatalw(msg string, keysAndValues ...interface{}) {}
func (s *MockSugarLogger) With(args ...interface{}) forge.SugarLogger      { return s }
