...
func NewLaunchDarklyProvider(config LaunchDarklyConfig, defaults map[string]interface{}) (Provider, error) {
	return nil, fmt.Errorf("launchdarkly provider not yet available - dependencies not resolved")
}
...
func NewUnleashProvider(config UnleashConfig, defaults map[string]interface{}) (Provider, error) {
	return nil, fmt.Errorf("unleash provider not yet available - dependencies not resolved")
}
...
func NewFlagsmithProvider(config FlagsmithConfig, defaults map[string]interface{}) (Provider, error) {
	return nil, fmt.Errorf("flagsmith provider not yet available - dependencies not resolved")
}
...
func NewPostHogProvider(config PostHogConfig, defaults map[string]interface{}) (Provider, error) {
	return nil, fmt.Errorf("posthog provider not yet available - dependencies not resolved")
}
...
func (l *noopSugarLogger) Debugw(msg string, keysAndValues ...interface{})  {}
func (l *noopSugarLogger) Infow(msg string, keysAndValues ...interface{})   {}
func (l *noopSugarLogger) Warnw(msg string, keysAndValues ...interface{})   {}
func (l *noopSugarLogger) Errorw(msg string, keysAndValues ...interface{})  {}
func (l *noopSugarLogger) Fatalw(msg string, keysAndValues ...interface{})  {}
func (l *noopSugarLogger) With(args ...interface{}) forge.SugarLogger       { return l }
...
func (a *localProviderAdapter) GetJSON(ctx context.Context, flagKey string, userCtx *UserContext, defaultValue interface{}) (interface{}, error) {
	return a.provider.GetJSON(ctx, flagKey, convertUserContext(userCtx), defaultValue)
}

func (a *localProviderAdapter) GetAllFlags(ctx context.Context, userCtx *UserContext) (map[string]interface{}, error) {
