...
func NewDatabaseHealthCheckFactory(container common.Container) *DatabaseHealthCheckFactory {
...
func RegisterDatabaseHealthChecks(healthService health.HealthService, container common.Container) error {
	...
	for _, db := range databases {
		...
		if err := healthService.RegisterCheck(db.name, check); err != nil {
